                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>3年</td>
                            <td>要件定義, 設計, 実装, リリース, 保守, 運用, 移管, リプレース</td>
                        </tr>
                        <tr>
                            <th scope="row">SRE</th>
                            <td>2.5年</td>
                            <td>障害対応, 攻撃対応, 冗長化, バックアップ, アップデート, サービスレベル定義</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>3年</td>
                            <td>WEBアプリケーション開発(PHP), ネイティブアプリケーション開発(C#)</td>
                        </tr>
                        <tr>
                            <th scope="row">コーポレートエンジニア</th>
                            <td>3年</td>
                            <td>ヘルプデスク, 資産管理, オフィス設計, ファシリティ管理, セキュリティ対応</td>
                        </tr>
                    </tbody>
                </table>
            </p>
            ...
            <div class="accordion">
                <div class="accordion-item">
                    ...
                    <div class="accordion-content">
                        ...
                        <p>2021年10月 株式会社ゼロマーケティングから社名変更、WEBマーケティング事業から事業変更。2024年12月 株式会社コアテックと吸収合併<a href="https://core-tech.jp" target="_blank">https://core-tech.jp</a></p>
