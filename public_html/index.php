...
<body id="top">
    ...
    <main>
        ...
        <section id="introduction">
            <p>1996年生まれ / 山形県出身</p>
            <p>中学生くらいまでは税理士を目指していたが、高校で簿記よりもプログラミングの方が楽しいことに気が付きエンジニアを目指し始めました。大学でコンピューターサイエンスを学んだことをキッカケにサーバー&ネットワーク分野の面白さにハマり、技能五輪全国大会に代表選手として出場。</p>
            <p>新卒入社した地元のソフトウェア会社でソフトウェアエンジニアとなり東北6県の製造業をターゲットとした生産管理システムやERP機能の開発に2年間従事しましたが、どうしてもインフラエンジニアになってみたくなり2018年に上京しました。</p>
            <p>WEBマーケティング会社のフルスタックエンジニア兼SREとして参画、開発と基盤構築に従事しリードエンジニアとエンジニアリングマネージャーを務めたのち、2023年より同社の事業責任者としてプロダクトの企画開発を推進しました。</p>
            <!-- アコーディオン -->
            <div class="accordion">
