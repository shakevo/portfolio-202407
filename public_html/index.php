            ...
            <div class="accordion">
                <div class="accordion-item">
                    ...
                    <div class="accordion-content">
                        ...
                        <p>中学生くらいまで税理士を目指していたが、高校で簿記よりもプログラミングの方が楽しいことに気が付きシステムエンジニアを目指し始める。大学でコンピューターサイエンスを学んだことをキッカケにサーバー&ネットワーク分野の面白さにハマり、Cisco機器を自分で買いそろえネットワーク構築に没頭。ネットワーク構築の全国大会に県代表選手として出場。</p>
            ...
            <div class="accordion">
                <div class="accordion-item">
                    ...
                    <div class="accordion-content">
                        ...
                        <h3>テクニカルサポート部 副主任 / クラウドエンジニア, インフラエンジニア 【2019.10】</h3>
                        ...
                        <h3>テクニカルサポート課 / バックエンドエンジニア, フロントエンドエンジニア, インフラエンジニア 【2018.05】</h3>
                        ...
                        <p>数百のドメインを50以上の他社レンタルサーバで稼働させていた環境を、ドメイン外部公開の自動化とサーバチューニングにより自社ホスティングサービス化することで、運用保守にかかる人的工数を減らし、サーバのランニングコストの削減を達成。</p>
                        <p><span class="bold-text03">集客媒体開発 | 2018.09-2019.02</span></p>
                        <p>集客媒体の自社開発案件でPG(PHP)とサーバ設計構築を兼務。要求されたサービスレベルを満たす高可用性アーキテクチャをAWSで提案・設計・構築を行いました。</p>
                    </div>
                </div>
                <br>
            </div>
            ...
            <div class="accordion">
                <div class="accordion-item">
                    ...
                    <div class="accordion-content">
                        ...
                        <p>顧客折衝を伴う上流工程から下流工程まで一連のソフトウェア開発工程を担当。スクラッチ開発案件での受発注管理/売上管理/顧客管理/各種財務会計文書発行/請求管理といったERP機能開発プロジェクトで開発を担当。</p>
