            ...
            <div class="accordion">
                <div class="accordion-item">
                    ...
                    <div class="accordion-content">
                        ...
                        <h3>プロダクトマネージャー, ディレクター / プロダクトデベロップメント本部 【2024.10-】</h3>
            ...
            <div class="accordion">
                <div class="accordion-item">
                    ...
                    <div class="accordion-content">
                        ...
                        <!-- section -->
                        <h3>エンジニアリングマネージャー, プロダクトマネージャー / システム統括部 次長 【2023.12-2024.09】</h3>

                        <!-- section -->
                        <h3>エンジニアリングマネージャー, アーキテクト / インテグレーション事業部 システム統括課 課長 【2021.10-2023.12】</h3>

                        <!-- section -->
                        <h3>プロジェクトマネージャー, アーキテクト / インテグレーション事業部 システム統括課 課長代理 【2021.04-2021.10】</h3>

                        <!-- section -->
                        <h3>アーキテクト, リードエンジニア, クラウドエンジニア / インテグレーション事業部 開発課 主任 【2020.04-2021.04】</h3>

                        <!-- section -->
                        <h3>クラウドエンジニア, インフラエンジニア / テクニカルサポート部 開発課 副主任 【2019.10-2020.04】</h3>
                        <p><span class="bold-text03">AWS大規模障害対応 (2019.10-2020.04)</span></p>
                        <p>EC2とRDSのAWS側基盤起因のアクセス障害発生時の障害対応を実施。障害発生中の「障害原因の特定」「障害範囲切り分け」「サービス復旧対応」の他、事後対応として責任分担モデルを軸に「ユーザやステークホルダーへの説明」「クラウド継続のメリット共有」「サービス冗長化対応」を推進致しました。</p>                        
                        
                        <!-- section -->
                        <h3>バックエンドエンジニア, フロントエンドエンジニア, インフラエンジニア / テクニカルサポート課 【2018.05-2019.10】</h3>
                        <p><span class="bold-text03">自社ホスティングサービスの構築 (2019.06-2019.09)</span></p>
                        <p>WEBサイトの公開環境を安価で提供するプライベートなホスティングサービスを構築。要件定義、設計、構築、テスト、リリースの全工程をPLとして担当。</p>
                        <p>
                            数百のドメインを50以上の他社レンタルサーバで稼働させていた環境を、ドメイン外部公開の自動化とサーバチューニングにより自社ホスティングサービス化することで、運用保守にかかる人的工数を減らし、サーバのランニングコストの削減を達成。
                        </p>
                        <p><span class="bold-text03">集客媒体開発 (2018.09-2019.02)</span></p>
                        <p>
                            集客媒体の自社開発案件でPG(PHP)とサーバ設計構築を兼務。要求されたサービスレベルを満たす高可用性アーキテクチャをAWSで提案・設計・構築を行いました。
                        </p>
                    </div>
                </div>
                <br>
            ...
            <div class="accordion">
                <div class="accordion-item">
                    ...
                    <div class="accordion-content">
                        ...
                        <!-- section -->
                        <h3>ソフトウェアエンジニア / 製造ソリューション本部 【2016.03】</h3>
                        <p><span class="bold-text03">コーディング自動化による工数削減 | 2017.08-2018.04</span></p>
                        <p>
                            複数のソフトウェア開発を重ねていく内にModelクラスにおけるコーディング工数の無駄を見つけた為、この工数削減のためDB設計情報をインポートしModelクラスを自動生成するシステムを開発し適用することで、1機能につき50%程度の工数削減を達成しました。
                        </p>
                        <p>
                            またシステムは対応するフレームワークであれば複数案件で流用が可能なよう作成したため、他作業メンバーにも配布し工数削減に貢献いたしました。
                        </p>
                        <p><span class="bold-text03">製造業向けアプリケーション ERP機能開発 | 2017.04-2018.04</span></p>
                        <p>
                            顧客折衝を伴う上流工程から下流工程まで一連のソフトウェア開発工程を担当。スクラッチ開発案件での受発注管理/売上管理/顧客管理/各種財務会計文書発行/請求管理といったERP機能開発プロジェクトで開発を担当。
                        </p>
                        <p><span class="bold-text03">製造業向け生産管理システム開発 | 2016.03-2018.04</span></p>
                        <p>
                            顧客折衝を伴う上流工程から下流工程まで一連のソフトウェア開発工程を担当。生産管理ソフトウェアにおける在庫管理/生産計画/予算管理/所要量管理/工程管理/品質管理といった工程の管理システムを開発。
                        </p>
                    </div>
                </div>
                <br>
